...
<body class="home">
  ...
  <section class="flex justify-end">
    <img src="<?php echo e(asset('/foto.png')); ?>" class="budi">
   
        <div class="text-white p-20">
         <h4 class="text-xl font-semibold">HI, IT'S ME!</h4> 
          <h2 class="text-3xl font-bold sm:text-4xl">ANDIKA BUDIARGO</h2>
          <h3 class="text-xl font-bold">AND I'M A <span class="multiple-text text-red-600"> </span></h3>
  <br>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
          <p>Itaque beatae quis, eveniet, quo, explicabo consequatur veritatis et quia porro</p>
          <p>cupiditate id tempora adipisci velit at voluptatem accusamus magnam est sint.<p>
       ...
       <!-- </a>-->
          ...
          <a href="https://drive.google.com/uc?export=download&id=10Sa7Cru6wgg6j0q05TrQGQLmt4yjPBYv">
          <button class="download-button">
            <div class="docs"><svg class="css-i6dzq1" stroke-linejoin="round" stroke-linecap="round" fill="none" stroke-width="2" stroke="currentColor" height="47" width="20" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line y2="13" x2="8" y1="13" x1="16"></line><line y2="17" x2="8" y1="17" x1="16"></line><polyline points="10 9 9 9 8 9"></polyline></svg> Download My CV</div>
            <div class="download">
  ...
  const typed = new Typed(".multiple-text", {
    strings: ["IT OFFICER", "WEB DEVELOPER", "OFFICE ADMINISTRATION", "CONTENT WRITER"],
typeSpeed: 50,
backSpeed: 70,
backDelay: 1000,
loop: true
...
</html><?php /**PATH C:\xampp\htdocs\web-portofolio\resources\views/home.blade.php ENDPATH**/ ?>